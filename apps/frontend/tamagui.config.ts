...
const config = createTamagui({
  ...
  fonts: {
    ...
    // Manga cinematic display face: Bangers, a single weight (400) - only
    // ever used at hero/title sizes for a victory/defeat verdict headline
    // (round-flash.tsx/outcome-cinematic.tsx), never for running text. See
    // ObsidianVault/game-victory-defeat-cinematic-2026-09-14.md.
    display: createFont({
      family: 'Bangers, Bangers_400Regular, sans-serif',
      size: {
        1: 12,
        2: 14,
        3: 15,
      ...
      face: {
        400: { normal: 'Bangers_400Regular' },
      },
    }),
    // Manga onomatopoeia/name-reveal face - Dela Gothic One, the only face
    // in this project that covers katakana (ゴゴゴ/ドン), also used for the
    // victory cinematic's winner-name reveal.
    mangaAccent: createFont({
      family: 'Dela Gothic One, DelaGothicOne_400Regular, sans-serif',
      size: {
        1: 11,
        2: 12,
        3: 13,
      ...
      face: {
        400: { normal: 'DelaGothicOne_400Regular' },
      },
    }),
  },
  tokens: {
