        ...
        >
          ...
          >
            <YStack gap="$4" pb="$2">
              ...
              {pictureUri ? (
                // The focal point itself is chosen in FocalPointModal - a
                // mandatory step right after picking a picture, reopenable
                // here via "Ajustar encuadre". This is just a small live
                // preview of the currently-saved framing plus that button,
                // not the picker itself (see stands-screen.tsx for the
                // modal, stands-container.tsx for the confirm/reopen wiring).
                <Controller
                  control={control}
                  name="focalX"
